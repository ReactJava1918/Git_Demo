...
public class Printing1to10NumbersSequentiallybyThreeThreadsWithExecutorandNormalThreads {
	...
	private static void executorService(Printing printing) {
	...
	private static void normalThread(Printing printing) {
		Runnable runnable = () -> {
        	printing.implementPrint();
